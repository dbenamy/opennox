...
func TestWorldCollisionsUndeadDamage(t *testing.T) {
	...
	defer func() {
		spellbookCapture(t, "world-collisions-undead-damage", rows, "d392885370f8910928f5673916e451a59125292fc830de9ef8d35f22978285d5")
	}()
				...
				for _, owned := range []bool{false, true} {
					...
					t.Run(name, func(t *testing.T) {
						...
						*observed = [6]uint32{}
						...
						legacy.PortTestWorldCollision(17, a, b, nil)
						amount := uint32(hp)
	...
	for _, normal := range []*types.Pointf{nil, new(types.Pointf)} {
		...
		a.DeletedNext = nil
		o.s.Objs.DeletedList = nil
		legacy.PortTestWorldCollision(17, a, nil, normal)
