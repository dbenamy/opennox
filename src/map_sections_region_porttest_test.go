...
func TestMapSectionsFloorRegionRead(t *testing.T) {
	...
	spellbookCapture(t, "map-sections-floor-region", out, "67448dfa8e2c593cd525b87a8634b3271ab410329af5ae0061db5d1ab0d52fb1")
}
