...
func TestCollisionRegistryWorldSoulGate(t *testing.T) {
	...
	defer func() {
		collisionRegistryCapture(t, "collision-registry-world-soul-gate", rows)
	}()
						...
						for _, player := range []bool{false, true} {
							...
							t.Run(name, func(t *testing.T) {
								...
								*o.globals["warpOpen"] = 2
								...
								collisionRegistryWorld(19, a, b, nil)
