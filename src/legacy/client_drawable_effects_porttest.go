...
func PortTestDrawableEffect(op int, dr *client.Drawable, a [5]uint32) uintptr {
	...
	case 1:
		...
		return 0
	case 2:
		return uintptr(C.nox_xxx_spriteShieldLoad_4B7F90())
	case 3:
	...
	case 4:
		...
		*key = a[0]
		defer free()
		C.nox_xxx_spriteScanForShield_4B81E0(C.int(uintptr(dr.C())), C.int(uintptr(unsafe.Pointer(key))))
		return 0
	case 5:
		return uintptr(C.sub_494F00())
	}
...
func PortTestDrawableEffectGlobals() ([]*uint32, func()) {
	words := []*uint32{(*uint32)(unsafe.Pointer(&C.dword_5d4594_1313740)), (*uint32)(unsafe.Pointer(&C.dword_5d4594_1313788)), (*uint32)(unsafe.Pointer(&C.dword_5d4594_1200776)), (*uint32)(unsafe.Pointer(&C.dword_5d4594_1200796))}
