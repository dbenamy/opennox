...
func PortTestInventoryDisplayWords() (map[string]*uint32, func()) {
	words := map[string]*uint32{
		...
		"dword_5d4594_1062484":     (*uint32)(unsafe.Pointer(&C.dword_5d4594_1062484)),
		...
		"nox_color_black_2650656":  (*uint32)(unsafe.Pointer(&C.nox_color_black_2650656)),
		"nox_color_blue_2650684":   (*uint32)(unsafe.Pointer(&C.nox_color_blue_2650684)),
		"nox_color_cyan_2649820":   (*uint32)(unsafe.Pointer(&C.nox_color_cyan_2649820)),
		"nox_color_orange_2614256": (*uint32)(unsafe.Pointer(&C.nox_color_orange_2614256)),
		"nox_color_red_2589776":    (*uint32)(unsafe.Pointer(&C.nox_color_red_2589776)),
		"nox_color_violet_2598268": (*uint32)(unsafe.Pointer(&C.nox_color_violet_2598268)),
		"nox_color_white_2523948":  (*uint32)(unsafe.Pointer(&C.nox_color_white_2523948)),
		"nox_color_yellow_2589772": (*uint32)(unsafe.Pointer(&C.nox_color_yellow_2589772)),
	}
