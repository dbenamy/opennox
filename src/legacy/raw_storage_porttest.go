...
var rawStorageContracts = []rawStorageContract{
	{name: "nox_xxx_aClosewoodengat_587000_133480", ptr: unsafe.Pointer(&legacyGlobals.nox_xxx_aClosewoodengat_587000_133480), size: unsafe.Sizeof(legacyGlobals.nox_xxx_aClosewoodengat_587000_133480), wantSize: 4, align: 4, alias: func() unsafe.Pointer { return unsafe.Pointer(&legacyGlobals.nox_xxx_aClosewoodengat_587000_133480) }, readWord: func() uint32 {
		return uint32(uintptr(unsafe.Pointer(legacyGlobals.nox_xxx_aClosewoodengat_587000_133480)))
	}, writePointer: func(p unsafe.Pointer) { legacyGlobals.nox_xxx_aClosewoodengat_587000_133480 = (unsafe.Pointer)(p) }},
	{name: "dword_5d4594_831236", ptr: unsafe.Pointer(&legacyGlobals.dword_5d4594_831236), size: unsafe.Sizeof(legacyGlobals.dword_5d4594_831236), wantSize: 4, align: 4, alias: func() unsafe.Pointer { return unsafe.Pointer(&legacyGlobals.dword_5d4594_831236) }, readWord: func() uint32 { return uint32(legacyGlobals.dword_5d4594_831236) }, writeWord: func(v uint32) { legacyGlobals.dword_5d4594_831236 = C.uint32_t(v) }},
	{name: "dword_5d4594_1309720", ptr: unsafe.Pointer(&legacyGlobals.dword_5d4594_1309720), size: unsafe.Sizeof(legacyGlobals.dword_5d4594_1309720), wantSize: 4, align: 4, alias: func() unsafe.Pointer { return unsafe.Pointer(&legacyGlobals.dword_5d4594_1309720) }, readWord: func() uint32 { return uint32(legacyGlobals.dword_5d4594_1309720) }, writePointer: func(p unsafe.Pointer) { legacyGlobals.dword_5d4594_1309720 = C.uint32_t(uintptr(p)) }, writeWord: func(v uint32) { *(*uint32)(unsafe.Pointer(&legacyGlobals.dword_5d4594_1309720)) = v }},
	{name: "dword_587000_127004", ptr: unsafe.Pointer(&legacyGlobals.dword_587000_127004), size: unsafe.Sizeof(legacyGlobals.dword_587000_127004), wantSize: 4, align: 4, alias: func() unsafe.Pointer { return unsafe.Pointer(&legacyGlobals.dword_587000_127004) }, readWord: func() uint32 { return uint32(uintptr(unsafe.Pointer(legacyGlobals.dword_587000_127004))) }, writePointer: func(p unsafe.Pointer) { legacyGlobals.dword_587000_127004 = (unsafe.Pointer)(p) }},
	{name: "nox_alloc_tradeItems_2386496", ptr: unsafe.Pointer(&legacyGlobals.nox_alloc_tradeItems_2386496), size: unsafe.Sizeof(legacyGlobals.nox_alloc_tradeItems_2386496), wantSize: 4, align: 4, alias: func() unsafe.Pointer { return unsafe.Pointer(&legacyGlobals.nox_alloc_tradeItems_2386496) }, readWord: func() uint32 { return uint32(uintptr(unsafe.Pointer(legacyGlobals.nox_alloc_tradeItems_2386496))) }, writePointer: func(p unsafe.Pointer) { legacyGlobals.nox_alloc_tradeItems_2386496 = (unsafe.Pointer)(p) }},
	{name: "dword_587000_93164", ptr: unsafe.Pointer(&legacyGlobals.dword_587000_93164), size: unsafe.Sizeof(legacyGlobals.dword_587000_93164), wantSize: 4, align: 4, alias: func() unsafe.Pointer { return unsafe.Pointer(&legacyGlobals.dword_587000_93164) }, readWord: func() uint32 { return uint32(uintptr(unsafe.Pointer(legacyGlobals.dword_587000_93164))) }, writePointer: func(p unsafe.Pointer) { legacyGlobals.dword_587000_93164 = (unsafe.Pointer)(p) }},
	...
	{name: "nox_alloc_spawn_2386216", ptr: unsafe.Pointer(&legacyGlobals.nox_alloc_spawn_2386216), size: unsafe.Sizeof(legacyGlobals.nox_alloc_spawn_2386216), wantSize: 4, align: 4, alias: func() unsafe.Pointer { return unsafe.Pointer(&legacyGlobals.nox_alloc_spawn_2386216) }, readWord: func() uint32 { return uint32(uintptr(unsafe.Pointer(legacyGlobals.nox_alloc_spawn_2386216))) }, writePointer: func(p unsafe.Pointer) { legacyGlobals.nox_alloc_spawn_2386216 = (unsafe.Pointer)(p) }},
	...
	{name: "byte_5D4594", ptr: unsafe.Pointer(&byte_5D4594[0]), size: uintptr(len(byte_5D4594)), wantSize: 2598284, align: 4, blobBase: 0x5d4594, alias: func() unsafe.Pointer { return unsafe.Pointer(&byte_5D4594[0]) }},
	{name: "byte_973CE0", ptr: unsafe.Pointer(&byte_973CE0[0]), size: uintptr(len(byte_973CE0)), wantSize: 568, align: 4, blobBase: 0x973ce0, alias: func() unsafe.Pointer { return unsafe.Pointer(&byte_973CE0[0]) }},
	{name: "byte_973F18", ptr: unsafe.Pointer(&byte_973F18[0]), size: uintptr(len(byte_973F18)), wantSize: 44881, align: 4, blobBase: 0x973f18, alias: func() unsafe.Pointer { return unsafe.Pointer(&byte_973F18[0]) }},
	{name: "byte_85B3FC", ptr: unsafe.Pointer(&byte_85B3FC[0]), size: uintptr(len(byte_85B3FC)), wantSize: 1029636, align: 4, blobBase: 0x85b3fc, alias: func() unsafe.Pointer { return unsafe.Pointer(&byte_85B3FC[0]) }},
	{name: "byte_852978", ptr: unsafe.Pointer(&byte_852978[0]), size: uintptr(len(byte_852978)), wantSize: 40, align: 4, blobBase: 0x852978, alias: func() unsafe.Pointer { return unsafe.Pointer(&byte_852978[0]) }},
	{name: "byte_973A20", ptr: unsafe.Pointer(&byte_973A20[0]), size: uintptr(len(byte_973A20)), wantSize: 704, align: 4, blobBase: 0x973a20, alias: func() unsafe.Pointer { return unsafe.Pointer(&byte_973A20[0]) }},
}
...
func rawStorageTypedEquipment(index int, v uint32) uint32 {
	legacyGlobals.array_5D4594_1049872[index] = C.uint32_t(v)
	return uint32(legacyGlobals.array_5D4594_1049872[index])
}
