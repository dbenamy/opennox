...
func portTestResourceProtection(p *portTestShopPools, sp *PortTestResourceSpec) (func() []uint32, func()) {
	...
	head, tail, key, sum, seq := dword_5d4594_2516344, dword_5d4594_2516352, dword_5d4594_2516348, dword_5d4594_2516328, dword_5d4594_2516356
	...
	*count, *swaps, *rekeys = uint16(len(records)), 0, 0
	...
	snapshot := func() []uint32 {
		...
		out := []uint32{key, uint32(dword_5d4594_2516328), uint32(dword_5d4594_2516356), uint32(*count), *swaps, *rekeys, p.normalize(uint32(dword_5d4594_2516344)), p.normalize(uint32(dword_5d4594_2516352))}
		for i := range records {
			b := &records[i]
	...
	restore := func() {
		...
		dword_5d4594_2516348, dword_5d4594_2516328, dword_5d4594_2516356 = key, sum, seq
