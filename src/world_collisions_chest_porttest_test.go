...
func TestWorldCollisionsChestContents(t *testing.T) {
	...
	defer func() {
		spellbookCapture(t, "world-collisions-chest-contents", rows, "78da915780f503688296b92367d629f4290ffb0059da4c2e4a4fee6ab7e8fc06")
	}()
			...
			for _, dead := range []bool{false, true} {
				for _, player := range []bool{false, true} {
					...
					t.Run(name, func(t *testing.T) {
						...
						legacy.PortTestWorldCollision(9, a, target, nil)
						opened := player && !dead
...
func TestWorldCollisionsChestKey(t *testing.T) {
	o := newWorldCollisionOwner(t)
			...
			for _, subclass := range []object.SubClass{0x100, 0x200, 0x400, 0x800} {
				...
				t.Run(label, func(t *testing.T) {
					...
					*o.throttle = 0
					...
					legacy.PortTestWorldCollision(9, a, b, nil)
	...
	spellbookCapture(t, "world-collisions-chest-key", rows, "ba76f6791f72e9594cb80a051718e25988cf2c8a14a502aad658a4f206c49e5c")
}
