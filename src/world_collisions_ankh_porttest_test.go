...
func TestWorldCollisionsAnkhHistory(t *testing.T) {
	...
	*(*byte)(unsafe.Add(player, 2251)) = 1
	...
	defer func() {
		spellbookCapture(t, "world-collisions-ankh-history", rows, "5a8075de055bcbab01d162400c32f4522ce528e861520e6a30198893ae4baca9")
	}()
					...
					for _, ticks := range []uint64{1500, 1501} {
						...
						t.Run(name, func(t *testing.T) {
							...
							*(*byte)(unsafe.Add(data, 5120)) = index
							...
							legacy.PortTestWorldCollision(20, a, b, nil)
	...
	legacy.PortTestWorldCollision(20, a, nil, nil)
}
