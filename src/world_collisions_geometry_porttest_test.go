...
func TestWorldCollisionsTrapGeometry(t *testing.T) {
	...
	defer func() {
		spellbookCapture(t, "world-collisions-trap-geometry", rows, "373a3d97827b104b69663daf050ab41fe3fb9424fecb1550064f264af12df6ed")
	}()
