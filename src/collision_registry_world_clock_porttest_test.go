...
func TestCollisionRegistryWorldClockThrottle(t *testing.T) {
	...
	defer func() {
		collisionRegistryCapture(t, "collision-registry-world-clock-throttle", rows)
	}()
				...
				for _, gate := range []bool{false, true} {
					...
					t.Run(name, func(t *testing.T) {
						...
						*(*byte)(unsafe.Add(a.UpdateData, 1)) = 5
						...
						collisionRegistryWorld(op, a, b, nil)
						var sounds []int
